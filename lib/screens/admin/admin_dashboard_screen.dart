...
class _AdminDashboardScreenState extends State<AdminDashboardScreen>
  ...
  Widget _buildPageContent(bool isDark) {
    switch (_selectedNavIndex) {
      ...
      case 4:
        return _buildPlaylistsPage(isDark);
      default:
        return _buildDashboardPage(isDark);
    }
  }
  ...
  // =============== PAGE 4: PLAYLISTS ===============
  Widget _buildPlaylistsPage(bool isDark) {
        ...
        children: [
          ...
          if (playlists.isEmpty)
            Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? const Color(0xFF161622) : Colors.grey[200],
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (success) {
                ...
                _setStatus('Failed to create playlist', isSuccess: false);
              }
            },
